...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_5wulsbb', 'template_a6flp85', formRef.current, 'n_rMO9T2KXNcwC658')
          .then((result) => {
              setSuccess(true)
          }, (error) => {
            setError(true)
  ...
  return (
    ...
    >
        <motion.div className="textContainer" variants={variants}>
            ...
            <motion.div className="item" variants={variants}>
                <h2>Address</h2>
                <span>Temeke street Dar Es Salaam</span>
            </motion.div>
            <motion.div className="item" variants={variants}>
                <h2>Phone</h2>
                <span>+255629595227</span>
            </motion.div>
        </motion.div>
